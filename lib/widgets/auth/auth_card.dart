            ...
            child: Column(
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    final passWordRequiredError =
                        FormValidators.requiredFieldValidator(value);
                    final weakPasswordError =
                        FormValidators.weakPasswordValidator(value);

                    if (passWordRequiredError != null) {
                      return passWordRequiredError;
                    } else if (weakPasswordError != null) {
